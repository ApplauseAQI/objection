...
- (void)bindProvider:(id<ApplauseJSObjectionProvider>)provider toClass:(Class)aClass inScope:(ApplauseJSObjectionScope)scope named:(NSString *)name;
...
- (void)bindProvider:(id<ApplauseJSObjectionProvider>)provider toProtocol:(Protocol *)aProtocol inScope:(ApplauseJSObjectionScope)scope named:(NSString *)name;
...
- (void)bindBlock:(id (^)(ApplauseJSObjectionInjector *context))block toClass:(Class)aClass inScope:(ApplauseJSObjectionScope)scope named:(NSString *)name;
...
- (void)bindBlock:(id (^)(ApplauseJSObjectionInjector *context))block toProtocol:(Protocol *)aProtocol inScope:(ApplauseJSObjectionScope)scope named:(NSString *)name;
